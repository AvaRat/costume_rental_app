...
CREATE TABLE "Costumes_inventory" (
	...
	"rental_id" int NOT NULL,
	CONSTRAINT "Costumes_inventory_pk" PRIMARY KEY ("costume_id")
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE "Locations" ADD CONSTRAINT "Locations_fk0" FOREIGN KEY ("manager_id") REFERENCES "Employees"("employee_id");
...
ALTER TABLE "Reservations" ADD CONSTRAINT "Reservations_fk0" FOREIGN KEY ("attendant_id") REFERENCES "Employees"("employee_id");
ALTER TABLE "Reservations" ADD CONSTRAINT "Reservations_fk1" FOREIGN KEY ("client_id") REFERENCES "Clients"("client_id");
...
ALTER TABLE "Costumes_inventory" ADD CONSTRAINT "Costumes_inventory_fk0" FOREIGN KEY ("model_id") REFERENCES "Costume_models"("model_id");
ALTER TABLE "Costumes_inventory" ADD CONSTRAINT "Costumes_inventory_fk1" FOREIGN KEY ("rental_id") REFERENCES "Costume_rentals"("rental_id");
